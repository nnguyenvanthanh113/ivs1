...
import 'package:ivs1/ListToday.dart';
...
class _MyHomeState extends State<MyHome> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(body: Column(children: <Widget>[
      ...
      Padding(
        padding: const EdgeInsets.all(8.0),
        child: RaisedButton(
          child: Text('Danh Sách Trong Ngày'),
          //onPressed: showNotification,
          onPressed: (){
            ...
            Navigator.push(context,
                MaterialPageRoute(builder: (context) => ListToday()));
          },
        ),
      ),
    ],)
  ...
  _checkInternetConnectivity() async {
    ...
    else if(result == ConnectivityResult.mobile || result == ConnectivityResult.wifi)
    {
      ...
      //xu ly kiem tra la Mã QR là checkIn hay checkOut
      Timer(Duration(seconds: 1), () {
        //post data lên kintone
        checkInOrcheckOut(checkQR);
      });
  ...
  Future<void> checkInOrcheckOut(String checkQR) async{
    ...
    String url = 'https://kintoneivsdemo.cybozu.com/k/v1/records.json?app=$Code_app&query=date = "$DateNow" and staffCode="$qrText"';
    ...
    {
      //timeOut = converDataToJson['records'][0]['timeOut']['value'];
      ...
      if(data.length > 0)
        {
          ...
          CheckOut(Record_number);

        }
      if(data.length <= 0 || data.length == null || data == 0)
        {
  ...
  //post data checkOut
  Future<void> CheckOut(String Record_number) async {
    ...
    //String json = '{"app": "' + Code_app +'","id":"'+ Record_number +'","record":"timeOut":{"value": "'+ TimeNow +'"}}}';
    String json = '{"app":"' + Code_app + '","id":"' + Record_number + '", "record": {"timeOut": {"value":"' + TimeNow + '"}}}';
    print("URL : " + json);
    print(qrText);
...
//    print(body);
    ...
    if(statusCode == 200 || statusCode == 201)
    {
      ...
      RichDialog.SuccesDialog(context, "checkOut thành công !",'$qrText : $StaffName');
      //showNotification;
    }
    else
    {
      ...
      RichDialog.ErrorDialog(context, "checkOut thất bại !","...");
    }
    ...
    if(statusCode == 200 || statusCode == 201)
      {
        ...
        //hien Dialog
        //MsgDialog.showMsgDialog(context, "gởi thành công !",'$qrText : $StaffName');
        RichDialog.SuccesDialog(context, "checkIn thành công !",'$qrText : $StaffName');
        //showNotification;
      }
    else
      {
        ...
        //hien Dialog
        //MsgDialog.showMsgDialog(context, "gởi thất bại !","...");
        RichDialog.ErrorDialog(context, "checkIn thất bại !","...");
      }
